...
public:
    int maxNumEdgesToRemove(int n, vector<vector<int>>& edges) {
        ...
        /*
        find answer for each Alice and Bob individually and store the types along with edges and only count the union of both answers

        find MST for each using DSU
        */
